      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden scale-in hover:shadow-3xl transition-all duration-500">
          ...
          <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 px-6 py-10 text-white relative overflow-hidden">
            ...
            <h1 className="text-4xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-pink-100">
              MoneySaver Pro
            </h1>
            <p className="text-center text-purple-100 mt-3 font-medium">Your Personal Finance Assistant</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            {(error || localError) && (
              <div className="bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-300 text-red-700 px-4 py-3 rounded-xl text-sm font-medium fade-in">
                {error || localError}
              </div>
            )}
          ...
          {/* Footer */}
          <div className="border-t-2 border-gradient-to-r from-indigo-200 to-pink-200 px-8 py-5 bg-gradient-to-r from-indigo-50 to-purple-50">
        ...
        <div className="mt-8 bg-white/90 backdrop-blur-xl border-2 border-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
